...
- **Collected at:** 2026-08-26T11:49:04Z
...
|---|---|---|---|---|---|
| `uv run pytest -n auto -q -m "not statistical"` | 0 | 446 | 0 | 0 | 446 passed, 36 warnings in 23.32s |
| `uv run ruff check src tests scripts` | 0 | - | - | - | All checks passed! |
| `uv run pyright` | 0 | 0 | 0 | 0 | 0 errors, 0 warnings, 0 informations |
...
|---|---|---|
| `pymc_marketing_mcp-0.4.0-py3-none-any.whl` | 140741 | `fae24ab6204461be2159c6cbf2c4919eb928bf6dc8fe5ab79001e069ea292801` |
| `pymc_marketing_mcp-0.4.0.tar.gz` | 286624 | `17bedec92c34cf94b70dc19a334032dc57ed61b1b7b8e28e504cb2d8bc159f1c` |
